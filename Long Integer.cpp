/*
    We Know in Cpp The biggest data Type Is Long Long Int which is Equal = 10^18 ; 
    Here in my Code you can enter as you want number of Integers , and also do some 
    Extra Implanmentions in your number . 
*/
#include <iostream>
#include <string>
#include <iomanip>
